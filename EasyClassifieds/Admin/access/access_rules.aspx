...
<script runat="server">
	...
	private void PopulateTree()
	{
		...
		try
		{
			FolderTree.SelectedNode.ImageUrl = "/Admin/Images/target.gif";
		}
		catch { }
	}
	...
	protected void FolderTree_SelectedNodeChanged(object sender, EventArgs e)
	{
		...
		FolderTree.SelectedNode.ImageUrl = "/Admin/Images/target.gif"; // Set the newly selected folder's ImageUrl.
	}
	...
	private void ResetFolderImageUrls(TreeNode parentNode)
	{
		...
		parentNode.ImageUrl = "/Admin/Images/folder.gif";
		...
		<tr>
			<td valign="top" style="padding-right: 30px;">
				...
				<asp:TreeView runat="server" ID="FolderTree"
					...
					<RootNodeStyle ImageUrl="/Admin/Images/folder.gif" />
					<ParentNodeStyle ImageUrl="/Admin/Images/folder.gif" />
					<LeafNodeStyle ImageUrl="/Admin/Images/folder.gif" />
