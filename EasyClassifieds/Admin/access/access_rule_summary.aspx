...
<script runat="server">
	...
	private TreeNode AddNodeAndDescendents(string byUserOrRole, DirectoryInfo folder, TreeNode parentNode)
	{
		...
		node.ImageUrl = (action.Substring(0, 5) == "ALLOW") ? "/Admin/Imagesgreenlight.gif" : "/Admin/Imagesredlight.gif";
		...
		<tr>
			<td valign="top" style="padding-right: 30px;">
				...
				<asp:TreeView runat="server" ID="FolderTree"
					...
					<ParentNodeStyle ImageUrl="~/Admin/Imagesfolder.gif" />
					<LeafNodeStyle ImageUrl="~/Admin/Imagesfolder.gif" />
